...
class Products {
  static Future<List<ProductsModelclass>> productsapi() async {
    final url =
        Uri.https(ConstUrl.basedummyjson, '/products/', {'limit': '10'});

    final res = await http.get(url);
    if (res.statusCode == 200) {
      final body = (jsonDecode(res.body));
      final List<ProductsModelclass> list = (body['products'] as List<dynamic>)
